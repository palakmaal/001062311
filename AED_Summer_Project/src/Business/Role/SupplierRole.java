...
import UserInterface.MedicalCentre.MedicalCentreWorkSpace;
/**
 *
 * @author maalp
 */
public class SupplierRole extends Role{
  @Override
    ...
    {
        return new MedicalCentreWorkSpace(container, userAccount, (DealerOrganization) organization, enterprise, network);
    }  
}
