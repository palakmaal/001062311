 ...
 * @author maalp
 */
public class Doctor_TestCentre extends javax.swing.JPanel {
     ...
     */
    public Doctor_TestCentre(JPanel container, UserAccount userAccount, Enterprise enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        banner.setText("Testing Centre Test Request");
    ...
    private void btnRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Please enter name correctly", "WARNING", JOptionPane.WARNING_MESSAGE);
            ...
            TestingCentre_TestWorkRequest request = new TestingCentre_TestWorkRequest();
            ...
            for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()){
                if (organization instanceof TestingCentreOrganization){
                    org = organization;
                    break;
                }
            }
