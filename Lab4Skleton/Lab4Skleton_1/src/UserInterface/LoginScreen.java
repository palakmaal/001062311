...
public class LoginScreen extends javax.swing.JPanel {
    ...
    public LoginScreen(JPanel panelRight, List<User> list, String CalledForm) {
        initComponents();
        this.list = list;
        this.panelRight = panelRight;
        this.CallingScreen = CalledForm;
        initialize();
        if(CallingScreen.equals("Supplier"))

        {  
       DefaultComboBoxModel  md1 = (DefaultComboBoxModel)comboUser.getModel();
       for(User u : this.list)
       {
           md1.addElement(u);
       }
        
       comboUser.setModel(md1);
          }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
      ...
      JOptionPane.showMessageDialog(null,txtPword.getText());
      return;
      }
