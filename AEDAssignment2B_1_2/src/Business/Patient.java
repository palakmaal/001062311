...
public class Patient 
{
   ...
   static void display(){
    ...
    System.out.println(p1.getRrlist()+"patient's Respiratory Rate Records");
    System.out.println(p1.getHrlist()+"patient's Heart Rate Records");
    System.out.println(p1.getBplist()+"patient's Blood Pressure Records ");
    System.out.println(p1.getWtlist()+"patient's Weight Records");
