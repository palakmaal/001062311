...
public class AbnormalViewVitalJPanel1 extends javax.swing.JPanel {
    ...
    public AbnormalViewVitalJPanel1(double maxbp, double minbp, VitalSignHistory vsh) {
        initComponents();
        this.vsh = vsh;
        this.maxbp = maxbp;
        this.minbp = minbp;
        bufferpopulateTable(maxbp, minbp);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            bufferpopulateTable(this.maxbp, this.minbp);
        } else {
            JOptionPane.showMessageDialog(null, "Please select a row.");
        }
...
private void bufferpopulateTable(double maxbp, double minbp) {
        DefaultTableModel dtm = (DefaultTableModel) vitalSignsTable.getModel();
        dtm.setRowCount(0);
